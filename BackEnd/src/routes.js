...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const prismaFeedbacksRepositoru = new prisma_feedbacks_repository_1.PrismaFeedbacksRepository;
    const nodemailerMailAdapter = new nodemailer_mail_adapter_1.NodemailerMailAdapter;
    const submitFeedbackUseCase = new submit_feedback_use_case_1.SubmitFeedbackUseCase(prismaFeedbacksRepositoru, nodemailerMailAdapter);
